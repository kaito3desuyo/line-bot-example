...
const SortDemaeFromDialogflow = (context, props) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (props.intent.displayName === 'demae-order-regist-address') {
        context.setState({
            params: Object.assign(Object.assign({}, context.state.params), { location: (_c = (_b = props === null || props === void 0 ? void 0 : props.parameters) === null || _b === void 0 ? void 0 : _b.fields) === null || _c === void 0 ? void 0 : _c.location[(_f = (_e = (_d = props === null || props === void 0 ? void 0 : props.parameters) === null || _d === void 0 ? void 0 : _d.fields) === null || _e === void 0 ? void 0 : _e.location) === null || _f === void 0 ? void 0 : _f.kind] }),
        });
        ...
        context.setState({
            params: Object.assign(Object.assign({}, context.state.params), { menu: (_h = (_g = props === null || props === void 0 ? void 0 : props.parameters) === null || _g === void 0 ? void 0 : _g.fields) === null || _h === void 0 ? void 0 : _h.menu[(_l = (_k = (_j = props === null || props === void 0 ? void 0 : props.parameters) === null || _j === void 0 ? void 0 : _j.fields) === null || _k === void 0 ? void 0 : _k.menu) === null || _l === void 0 ? void 0 : _l.kind] }),
        });
...
const SayDemaeMenuAndRequestAddress = (context, props) => __awaiter(void 0, void 0, void 0, function* () {
    var _m;
    yield context.sendText(`あいよ！${((_m = context.state) === null || _m === void 0 ? void 0 : _m.params).menu}ね！`);
...
const SayAddressAndRequestConfirm = (context, props) => __awaiter(void 0, void 0, void 0, function* () {
    var _o;
    yield context.sendText(`あいよ！${((_o = context.state) === null || _o === void 0 ? void 0 : _o.params).location.fields['street-address'].stringValue}ね！`);
...
const Dialogflow = dialogflow_1.default({
    ...
    actions: {
        ...
        'demae-order-with-menu': SortDemaeFromDialogflow,
